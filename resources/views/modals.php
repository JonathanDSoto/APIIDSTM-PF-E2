...
<div class="container-xxl flex-grow-1 container-p-y">
  ...
  <div class="row mb-3">
    ...
    <div class="col-12 col-sm-6 col-lg-4 mb-4">
      <div class="card">
        <div class="card-body text-center">
          ...
          <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#paymentCustomer"> Pagar </button>
        </div>
      </div>
    </div>
    <!--/  PAYMENT CUSTOMER  -->
    ...
    <div class="col-12 col-sm-6 col-lg-4 mb-4">
        <div class="card">
            <div class="card-body text-center">
                <i class="mb-3 ti ti-user ti-lg"></i>
                <h5>Añadir Instructor</h5>
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#newInstructor"> Añadir </button>
            </div>
        </div>
    </div>
    <!--/  New instructor -->
    ...
    <div class="col-12 col-sm-6 col-lg-4 mb-4">
        <div class="card">
            <div class="card-body text-center">
                <i class="mb-3 ti ti-user ti-lg"></i>
                <h5>Editar Instructor</h5>
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editInstructor"> Editar </button>
            </div>
        </div>
    </div>
    <!--/  Edit instructor -->
    ...
    <div class="col-12 col-sm-6 col-lg-4 mb-4">
        <div class="card">
            <div class="card-body text-center">
                ...
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#deleteInstructor"> Eliminar </button>
            </div>
        </div>
    </div>
    <!--/  Delete instructor -->
  ...
  <div class="modal fade" id="newInstructor" tabindex="-1" aria-hidden="true">
      <div class="modal-dialog modal-lg modal-simple modal-new-instructor">
          <div class="modal-content p-3 p-md-5">
              <div class="modal-body">
                  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                  <div class="text-center mb-4">
                      <h3 class="mb-2">Añadir Instructor</h3>
                      <p class="text-muted">Ingresa todos los datos.</p>
                  </div>
                  <form id="newInstructorForm" class="row g-3" onsubmit="return false">
                      <div class="col-12 col-md-6">
                          <label class="form-label" for="newInstructorFirstName">Nombre(s)</label>
                          <input type="text" id="newInstructorFirstName" name="newInstructorFirstName" class="form-control" placeholder="Mark" />
                      </div>
                      <div class="col-12 col-md-6">
                          <label class="form-label" for="newInstructorLastName">Apellidos</label>
                          <input type="text" id="newInstructorLastName" name="newInstructorLastName" class="form-control" placeholder="Martin" />
                      </div>
                      <div class="col-12 col-md-6">
                          <label class="form-label" for="newInstructorEmail">Email</label>
                          <input type="text" id="newInstructorEmail" name="newInstructorEmail" class="form-control" placeholder="mark@gmail.com" />
                      </div>
                      <div class="col-12 col-md-6">
                          <label class="form-label" for="newInstructorPhone">Numero de Celular</label>
                          <div class="input-group">
                              <span class="input-group-text">MX (+52)</span>
                              <input type="text" id="newInstructorPhone" name="newInstructorPhone" class="form-control phone-number-mask" placeholder="(612) 000 000 0" />
                          </div>
                      </div>
                      <div class="col-12 col-md-6">
                          <label class="form-label" for="newInstructorPhoneEmergency">Numero Emergencia</label>
                          <div class="input-group">
                              <span class="input-group-text">MX (+52)</span>
                      ...
                      <div class="col-12 col-md-6">
                          ...
                          <select id="newInstructorBlood" name="newInstructorBlood" class="select2 form-select" aria-label="Default select example">
                            <option selected>Tipo sangre</option>
                            <option value="diario">A+</option>
                            <option value="mensual">A-</option>
                            <option value="anual">B+</option>
 ...
 <!-- Edit instructor Modal -->
      ...
      <div class="modal-dialog modal-lg modal-simple modal-edit-user">
          <div class="modal-content p-3 p-md-5">
              <div class="modal-body">
                  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                  <div class="text-center mb-4">
                      <h3 class="mb-2">Editar Informacion de Instructor</h3>
                      <p class="text-muted">Actualiza los datos permitidos.</p>
                  </div>
                  <form id="editInstructorForm" class="row g-3" onsubmit="return false">
                      <div class="col-12 col-md-6">
                          <label class="form-label" for="editInstructorFirstName">Nombre(s)</label>
                          <input type="text" id="editInstructorFirstName" name="editInstructorFirstName" class="form-control" placeholder="Mark" />
                      </div>
                      <div class="col-12 col-md-6">
                          <label class="form-label" for="editInstructorLastName">Apellidos</label>
                          <input type="text" id="editInstructorLastName" name="editInstructorLastName" class="form-control" placeholder="Martin" />
                      </div>
                      <div class="col-12 col-md-6">
                          <label class="form-label" for="editInstructorEmail">Email</label>
                          <input type="text" id="editInstructorEmail" name="editInstructorEmail" class="form-control" placeholder="mark@gmail.com" />
                      </div>
                      <div class="col-12 col-md-6">
                        <label class="form-label" for="editCustomerStatus">Status</label>
                        <select id="editCustomerStatus" name="editCustomerStatus" class="select2 form-select" aria-label="Default select example">
                      ...
                      <div class="col-12 col-md-6">
                          <label class="form-label" for="editInstructorPhone">Numero de Celular</label>
                          <div class="input-group">
                              <span class="input-group-text">MX (+52)</span>
                              <input type="text" id="editInstructorPhone" name="editInstructorPhone" class="form-control phone-number-mask" placeholder="(612) 123 123 0" />
                          </div>
                      </div>
                      <div class="col-12 col-md-6">
                          <label class="form-label" for="editInstructorPhoneEmergency">Numero Emergencia</label>
                          <div class="input-group">
                              <span class="input-group-text">MX (+52)</span>
                              <input type="text" id="editInstructorPhoneEmergency" name="editInstructorPhoneEmergency" class="form-control phone-number-mask" placeholder="(612) 123 123 9" />
                          </div>
                      </div>
                      <div class="col-12 col-md-6">
                          <label class="form-label" for="editInstructorFare">Especialidad/Clase</label>
                          <select id="editInstructorFare" name="editInstructorFare" class="select2 form-select" aria-label="Default select example">
                            <option value="pesas">Pesas</option>
                            <option value="entrenamientoFuncional" selected>Entrenamiento Funcional</option>
                            <option value="box">Boxeo</option>
                            <option value="spinning">Spinning</option>
                      ...
                      <div class="col-12 col-md-6">
                          <label class="form-label" for="editInstructorBlood">Tipo de sangre</label>
  ...
  <div class="modal fade" id="deleteInstructor" tabindex="-1" aria-hidden="true">
      <div class="modal-dialog modal-lg modal-simple modal-delete-instructor">
          <div class="modal-content p-3 p-md-5">
              <div class="modal-body">
                  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                  <div class="text-center mb-4">
                      <h3 class="mb-2">Eliminar Instructor</h3>
                  </div>
                  <form id="deleteInstructorForm" class="row g-3" onsubmit="return false">
                      <div class="col-12 text-center">
                          <h4 class="text-center" for="modalDeleteInstructorFirstName">¿Desea eliminar el instructor seleccionado?</h4>
                      </div>
                      <div class="col-12 text-center">
                          <button type="submit" class="btn btn-primary me-sm-3 me-1">Eliminar</button>
                          <button type="reset" class="btn btn-label-secondary" data-bs-dismiss="modal" aria-label="Close">Cancelar</button>
