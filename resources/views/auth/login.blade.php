      ...
      <div class="authentication-inner row">
        ...
        <div class="d-none d-lg-flex col-lg-7 p-0">
          <div class="auth-cover-bg auth-cover-bg-white d-flex justify-content-center align-items-center">
            <img src="{{asset('assets/img/illustrations/person-gym.jpg')}}" alt="auth-login-cover" class="img-fluid my-5 auth-illustration" data-app-light-img="illustrations/person-gym.jpg" data-app-dark-img="illustrations/person-gym.jpg">
          </div>
        </div>
        <!-- /Left Text -->
        <!-- Login -->
            ...
            <div class="app-brand mb-4">
              <a href="index.html" class="app-brand-link gap-2">
                <span class="app-brand-logo demo">
                  <img src="{{ asset('assets/img/favicon/gimnasio.ico') }}" alt="gimnasio" width="28" height="26">
                </span>
              </a>
            </div>
            <!-- /Logo -->
            <h3 class="mb-1">Bienvenido a GymXpert! 🏋️‍♀️</h3>
