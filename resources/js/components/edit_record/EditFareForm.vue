        ...
        <div class="modal-dialog modal-lg modal-simple modal-edit-user">
            <div class="modal-content p-3 p-md-5">
                <div class="modal-body">
                    ...
                    <form id="addFareForm" class="row g-3" :action="route('fares.update', { id: props.fare.id })" method="POST">
                        <FormAuth method="PUT" />
                        <div class="col-12 col-md-12">
                            <label class="form-label" for="newFareName">Nombre de la Tarifa</label>
                            <input type="text" id="newFareName" name="name" v-model="props.fare.name" class="form-control"
                                placeholder="Tarifa" />
                        </div>
                        <div class="col-12 col-md-6">
                            <label class="form-label" for="newFareCost">Costo</label>
                            <input type="text" id="newFareCost" name="price" v-model="props.fare.price" class="form-control"
                                placeholder="$200" />
                        </div>
                        <div class="col-12 col-md-6">
                            ...
                            <select id="editInstructorBlood" name="fare_period_id" class="select2 form-select"
                                ...
                                <option v-for=" farePeriod  in props.fare_periods" :value="farePeriod.id" :key="farePeriod.id">{{farePeriod.name}}</option>
                            </select>
                        </div>
                        <div class="col-12 col-md-12">
