                ...
                <div class="row mx-0 gy-3 px-lg-5">
                    ...
                    <div class="col-lg mb-md-0 mb-4" v-for="(fare, index) in props.fares" :key="fare.id">
                        <div class="card border rounded shadow-none">
                            <div class="card-body">
                                <span v-if="keyFareCount == fare.id"
                                    class="position-absolute top-0 end-0 m-3 badge bg-label-primary">Mas popular</span>
                                ...
                                <div class="d-flex justify-content-center">
                                    ...
                                    <button @click="selectedId = fare.id" class="btn btn-danger mx-3"
