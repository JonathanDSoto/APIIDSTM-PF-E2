...
return [
    ...
    'enum' => 'El valor ingresado en :attribute no es válido.',
    'exists' => 'El valor ingresado en :attribute no es válido.',
    ...
    'in' => 'El valor ingresado en :attribute no es válido.',
    ...
    'custom' => [
        'instructor_qualifications' => [
            'array' => 'Los datos en :attribute no son válidos.',
        ],
        'instructor_qualifications.*' => [
            'integer' => 'La especialidad del instructor seleccionada no es válida.'
        ],
        'price' => [
            'between' => [
                'numeric' => 'El campo :attribute ingresado no es válido.'
            ]
        ]
    ],
    ...
    'attributes' => [
        ...
        'emergency_phone' => 'número de teléfono de emergencia',
        'fare_id' => 'tarifa',
        'fare_period_id' => 'periodo',
        'instructor_qualifications' => 'especialidades del instructor',
        'is_active' => 'estado',
        'name' => 'nombre',
